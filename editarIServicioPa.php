  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Editar Imagen Servicio</li>
      </ol>
    <section id="tamasec">
        <?php
        ...
        <div class="containerlogin">
            <div class="card card-register mx-auto mt-5">
              ...
              <div class="card-body">
                <form action="editarIServicio.php?id=<?php echo $id;?>" method="post" enctype="multipart/form-data">
                <div class="form-row">
                      <div class="col-md-6">
                          <br>
                    ...
                    <div class="form-row">
                      <div class="col-md-6">
                          <br>
                        <label>Elija Nueva Imagen de  Servicio</label><br>

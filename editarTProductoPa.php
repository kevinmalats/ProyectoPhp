    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="tablatipoproducto.php">Tipo de Producto</a>
        </li>
        <li class="breadcrumb-item active">Modificar Tipo de Producto</li>
      </ol>
   <section id="tamasec">
        <?php
         ...
         $ser = $objeto->showtipoProducto($id);
         $nom = $ser->getNombre();
        ?>
        <div class="text-center"><p><?php echo $mensaje; ?></p></div>
        <div class="containerlogin">
            <div class="card card-register mx-auto mt-5">
              <div class="card-header">Modificar Tipo Producto</div>
              <div class="card-body">
                <form action="editarTProducto.php?id=<?php echo $id; ?>" method="post">
                  <div class="form-group">
                    <div class="form-row">
                      <div class="col-md-6">
                        <label>Editar Tipo Producto</label>

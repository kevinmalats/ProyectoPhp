  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="tablatiposervicio.php">Tipo de Servicio</a>
        </li>
   ...
   <section id="tamasec">
        <?php
         ...
         $ser = $objeto->comprobarTiposervicio($id);
         $nom = $ser->getNombre();
        ?>
        <div class="text-center"><p><?php echo $mensaje; ?></p></div>
        <div class="containerlogin">
            <div class="card card-register mx-auto mt-5">
              <div class="card-header">Modificar Tipo Servicio</div>
              <div class="card-body">
                <form action="editarTServicio.php?id=<?php echo $id; ?>" method="post">
                  <div class="form-group">
                    <div class="form-row">
                      <div class="col-md-6">
                        <label>Editar Tipo Servicio</label>

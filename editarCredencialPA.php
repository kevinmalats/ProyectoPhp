...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
   ...
   <section id="tamasec">
        ...
        $credencial = $objeto->showCredencial($recibido);
        $log = $credencial->getUsuario();
        $cla = $credencial->getClave();
        ?>
        <div class="text-center"><p><?php echo $mensaje;?></p></div>
        <div class="containerlogin">
            <div class="card card-register mx-auto mt-5">
              <div class="card-header">Modificar credencial</div>
              <div class="card-body">
                <form action="editarCredencial.php?cred=<?php echo $recibido; ?>" method="post">
